...
meta_summary<-t(data.frame(Female=female,Mean_GA=GA,mean_celltypes ))
rownames(meta_summary)<-c("Female","Mean Gestational Age","Monocytes","Granulocytes", "nRBCs","NK Cells", "B Cells", "CD4 T Cells","CD8 T Cells")
colnames(meta_summary)<-c("Cord Blood n=24")
