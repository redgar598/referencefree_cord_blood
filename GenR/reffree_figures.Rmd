...
## load meta data
meta_summary<-read.csv("~/RE_GenR/summarytable.csv", sep=";")
...
\newpage
```{r, echo=FALSE,  message=FALSE}
methods_table<-read.csv("~/RE_GenR/methods_table.csv")
...
ggsave("~/RE_GenR/Figure1R2.pdf", width = 9, height = 5, units = "in")
```
...
ggsave("~/RE_GenR/Figure2R2.pdf", width = 8, height = 7, units = "in")
...
load("~/RE_GenR/R2_inverse_plot.RData" )
...
ggsave("~/RE_GenR/Figure3R2.pdf", width = 8, height = 7, units = "in")
...
ggsave("~/RE_GenR/maehalf.pdf", width = 13, height = 11, units = "in")
...
```{r correlation, fig.width=12,  fig.height=10, echo=FALSE,  message=FALSE, fig.cap='Distributions of correlation of beta values across samples at each CpG. Betas across samples were correlated between each method and the gold-standard FACS-PCA corrected betas. Vertical blue line shows the median correlation across all CpGs for the Deconvolution PCA corrected betas.'}
 load("~/RE_GenR/correlation_distributions.RData")
...
ggsave("~/RE_GenR/Figure3cor.pdf", width = 12, height = 10, units = "in")
```
...
ggsave("~/RE_GenR/Figure4decon.pdf", width = 9, height = 11, units = "in")
...
load("~/RE_GenR/mads_melted.RData")
...
ggsave("~/RE_GenR/Figure5decon.pdf", width = 12, height = 10, units = "in")
```
